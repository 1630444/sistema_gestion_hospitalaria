<?php
  ...
  $query="SELECT id_cita, (SELECT nombre FROM usuarios WHERE id_usuario = P.usuario_id) nombre, hora ,(SELECT nombre FROM usuarios WHERE id_usuario = (SELECT usuario_id FROM medico WHERE id_medico= C.id_medico)) nombre_medico
  FROM pacientes P, cita C 
  WHERE P.id_paciente = C.id_paciente and P.usuario_id = {$_GET['id']};";
            ...
            <div class="box-body">
              <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                ...
                <tr role="row">
                  ...
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Nombre de Medico
                  </th>
                  <th>Más detalle</th>
                </tr>
                </thead>
                ...
                <?php
                  foreach ($res as $nota) {
                    ...
                    echo "<td>".$nota["nombre_medico"]."</td>";
                    echo "<td>
                    <div class=\"btn-group\">
                      <a  onclick=\"cargar(" . $nota["id_cita"] . ");\" href=\"modificar.php?id=".$nota["id_cita"]."\" type=\"button\" class=\"btn btn-info\"><i class=\"fa fa-fw fa-eye\"></i></a>
                    </div>
                  </td>";
                    echo "</tr>";
                  }
