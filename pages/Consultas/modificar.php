         ...
         <div id="msg">
          ...
          <div class="box">
            <div class="box-header with-border">
              ...
              <?php for($i=0;$i<53;$i++){echo '&emsp;';} ?>
              <a class="btbr" style="float:right;" onclick="cerrar()" href="http://eldelmomo.me/hospital/pages/Consultas/mostrar.php">Terminar Consulta</a>
            </div>
            <!-- Tab links -->
            <div class="tab">
