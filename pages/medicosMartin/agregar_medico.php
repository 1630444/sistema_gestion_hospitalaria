    ...
    if(isset($_POST['submit'])){
      ...
      if(!is_numeric($No_cedula))
        ...
        if(empty($email)) $email = 'null'; else $email = "'".$email."'";
          ...
          $query = "INSERT INTO medicos (`No_cedula`, `usuario_id`) VALUES ('{$No_cedula}', {$usuario_id});";
            ...
            <div class="box-body" align="">
              ...
              <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" role="form">
                ...
                <div class="box-body">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="No_cedula" placeholder="Ingrese el número de cedula profesional del medico" maxlength="11"
                             value="<?php if(!empty($errores)){ echo $No_cedula;} ?>" required>
                    </div>
                ...
                <div class="box-footer">
                  <button type="submit" class="btn btn-primary" style="float: right;" name="submit">Agregar medico</button>
                </div>
