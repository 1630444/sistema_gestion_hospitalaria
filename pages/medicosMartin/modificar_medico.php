<?php
  ...
  $id = $_GET['id'];
  $query = "SELECT * FROM usuarios INNER JOIN medicos ON usuarios.id_usuario = medicos.usuario_id WHERE usuario_id = {$id}";
  ...
  $errores = ''; 
    ...
    if(isset($_POST['submit'])){
      ...
      $cel = $_POST['cel'];
      $email = $_POST['email'];
      $No_cedula = $_POST['No_cedula'];
      
      
      if(!is_numeric($cp))
          $errores .= 'El codigo postal es invalido.<br/>';
      
      if(!is_numeric($No_cedula))
          $errores .= 'El número de cedula profesional es invalido.<br/>';
            ...
            <div class="box-body" align="">
              ...
              <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) . "?id={$id}" ?>" role="form">
                ...
                <div class="box-body">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control" name="email" placeholder="Ingrese el correo electronico del medico" maxlength="80"
                    ...
                    <div class="form-group">
                      <label for="nss">* No_cedula</label>
                      <input type="text" class="form-control" name="No_cedula" placeholder="Ingrese el número de cedula profesional del medico" maxlength="8"
                             value="<?php if(!empty($errores)){ echo $No_cedula;} else {echo $ruser['No_cedula'];} ?>" required>
                    </div>
                ...
                <div class="box-footer">
                  <button type="submit" class="btn btn-primary" style="float: right;" name="submit">Modificar Medico</button>
                </div>
